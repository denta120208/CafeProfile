...
const AboutPage: NextPage = () => {
    ...
    return (
        <Layout>
            <Head>
                <title>Tentang Kami - Foodpedia</title>
                <meta
                    name="description"
                    content="Mengenal lebih dekat Foodpedia, sejarah, dan tim kami yang berdedikasi menyajikan cita rasa nusantara."
                />
            </Head>
                ...
                <div className="container mx-auto max-w-6xl">
                    <div className="flex flex-col lg:flex-row gap-12 items-center">
                        ...
                        <motion.div className="lg:w-1/2" variants={fadeInUp}>
                            ...
                            >
                                Foodpedia didirikan pada tahun 2018 dengan
                            ...
                            >
                                ...
                                masakan nusantara, Foodpedia hadir sebagai wadah
                            ...
                            >
                                Nama {"Foodpedia"} sendiri merupakan perwujudan
                            ...
                            >
                                ...
                                fondasi Foodpedia hingga saat ini.
                            </motion.p>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="container mx-auto max-w-4xl">
                    ...
                    >
                        ...
                        <motion.p
                            ...
                            transition={{ delay: 0.2, duration: 0.6 }}
                        >
                            Tonggak penting dalam perjalanan Foodpedia
                            hingga saat ini
                        </motion.p>
                    </motion.div>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            ...
                            beragam cita rasa nusantara di Foodpedia.
                        </motion.p>
                        <motion.div
