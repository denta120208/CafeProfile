...
const MenuPage: NextPage = () => {
    ...
    return (
        <Layout>
            <Head>
                <title>Menu - Foodpedia</title>
                <meta
                    name="description"
                    content="Menu makanan dan minuman dari Foodpedia - Sajian autentik Indonesia"
                />
            </Head>
            ...
            >
                <div className="container mx-auto">
                    ...
                    {isLoading ? (
                    ...
                    ) : !paginatedMenuItems || paginatedMenuItems.length === 0 ? (
                        <motion.div
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            className="text-center py-12"
                        >
                            <p className="text-amber-800 text-lg">
                                Tidak ada menu tersedia. Silakan hubungkan database terlebih dahulu.
                            </p>
                        </motion.div>
                    ) : (
