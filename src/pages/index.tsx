...
const Home: NextPage = () => {
    return (
        <Layout>
            <Head>
                <title>Foodpedia - Sajian Autentik Indonesia</title>
                <meta
                    name="description"
                ...
                <div className="absolute inset-0 z-20 flex items-center justify-center text-center px-4">
                    <div className="max-w-3xl">
                        ...
                        >
                            ...
                            >
                                <a
                                    href="https://wa.me/6287790006003?text=Hi%20saya%20Mau%20reservasi%20Meja%20untuk%20Jam..."
                                    target="_blank"
                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            ...
                            suasana yang nyaman dan elegan di Foodpedia.
                        </p>
                    </motion.div>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            ...
                            Reservasi meja Anda untuk memastikan tempat di Foodpedia.
                        </motion.p>
                        <motion.div
                            variants={staggerContainer}
                            className="flex flex-col sm:flex-row gap-4 justify-center"
            ...
            >
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        >
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126871.92224475957!2d106.83619363906249!3d-6.426468918461788!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6995e9caa2b5d5%3A0xcb48203226112eb5!2sFoodpedia%20x%20Secangkir%20Cerita!5e0!3m2!1sid!2sid!4v1768990685396!5m2!1sid!2sid"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                                allowFullScreen
                        ...
                        >
                            <Link
                                href="https://maps.app.goo.gl/3F5D2KeMrxhChgas6"
                                target="_blank"
